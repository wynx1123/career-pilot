    ...
    <section className="min-h-screen bg-[#0a0a18] text-cyan-200 relative overflow-hidden font-mono text-sm">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-8 py-16 space-y-10">
        ...
        <div className="text-center space-y-3">
          ...
          <h2
            className="font-black text-5xl tracking-widest uppercase leading-none inline-block"
            style={{
              fontFamily: "'Orbitron', sans-serif",
              color: '#e0f4ff',
              textShadow: '0 0 20px rgba(160,220,255,0.9), 0 0 40px rgba(180,160,255,0.6), 0 0 80px rgba(200,140,255,0.3)',
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-5 items-start">
          ...
          <div className="md:col-span-5 relative rounded-sm p-6 backdrop-blur-2xl" style={{ background: 'rgba(10,8,30,0.65)' }}>
            ...
            {SKILLS.map((skill, i) => (
              <div key={skill} className="flex items-center gap-2.5 py-2 border-b border-white/[0.035] last:border-none group">
                <span className="text-[9px] text-sky-400/25 font-bold w-4 shrink-0">
                  {String(i + 1).padStart(2, '0')}
                </span>
                <span
                  className="flex-1 text-[11.5px] text-sky-100/75 tracking-wide"
                  style={{ transition: 'all 0.3s' }}
                  onMouseEnter={e => {
                    Object.assign(e.target.style, {
                      background: 'linear-gradient(90deg,#b8ecff,#e0b8ff,#ffd6f0,#b8ffec)',
                      backgroundSize: '200% auto',
                  ...
                  onMouseLeave={e => {
                    Object.assign(e.target.style, {
                      background: 'none',
                      WebkitTextFillColor: 'rgba(200,220,255,0.75)',
                      animation: 'none',
                    });
                  }}
                >
        ...
        {/* Footer */}
        <div className="flex justify-center gap-7 flex-wrap pt-5 relative"
          style={{ borderTop: '1px solid rgba(180,200,255,0.08)' }}>
      ...
      <style>{`
        ...
        @keyframes dotPulse {
          ...
          50%    { filter:brightness(1.8) drop-shadow(0 0 4px rgba(200,220,255,0.9)); }
        }
        @keyframes sparkle {
